...
public:
	...
	// Smooth 한 삼각형 그리기
	void SmoothDrawTriangle(GLfloat* a, GLfloat* b, GLfloat* c);
	void SmoothDrawQuad(GLfloat* a, GLfloat* b, GLfloat* c, GLfloat* d, floatUV* aUV, floatUV* bUV, floatUV* cUV, floatUV* dUV);
	//선그리기
